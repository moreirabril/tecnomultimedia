class Juego {
  ...
  void actualizar() {
    ...
    if (estado=="jugando") {
      ...
      if (puerta0.colision(jugador1.x,jugador1.y,jugador1.ancho/2)){
      estado="ganar";
    }
    }
  ...
  void presionar () {
    if (estado=="inicio" && mouseX > 450 && mouseX < 450+300 && mouseY > 250 && mouseY < 250+100 ) { //(450,250,300,100);
      boton1.mouseEncima(); 
      estado="jugando";
    } else if (estado=="morir" && mouseX > 450 && mouseX < 450+300 && mouseY > 460 && mouseY < 460+100 ) { //(450,460,300,100)
      boton2.mouseEncima(); 
      estado="inicio";
    }else if (estado=="ganar" && mouseX > 750 && mouseX < 750+300 && mouseY > 460 && mouseY < 460+100 ){  //r(750,460,300,100);
     boton3.mouseEncima(); 
      estado="inicio";
    }
  }
